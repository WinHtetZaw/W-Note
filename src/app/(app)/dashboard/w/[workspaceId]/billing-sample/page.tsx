    ...
    <>
      ...
      <div className="mt-10 grid gap-6 xl:grid-cols-[1fr_380px]">
        ...
        <div className="space-y-6">
          {/* Current Plan */}
          <section className="rounded-4xl border border-white/10 bg-white/5 p-8 backdrop-blur-2xl">
            <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
              <div>
                ...
                <p className="mt-3 max-w-xl text-zinc-400">
                  Unlimited AI generations, advanced workspace collaboration,
                  and priority support.
                </p>
              </div>

              <div className="rounded-[28px] border border-violet-500/20 bg-violet-500/10 p-6">
                <div className="text-sm text-zinc-400">Monthly Billing</div>

                <div className="mt-2 text-5xl font-black">$24</div>

                <div className="mt-2 text-sm text-zinc-400">per month</div>
              </div>
            </div>
        ...
        <aside className="space-y-6">
          ...
          <section className="rounded-4xl border border-white/10 bg-white/5 p-6 backdrop-blur-2xl">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-zinc-400">Monthly AI token usage</p>
              </div>
            </div>
          ...
          {/* Next Payment */}
          <section className="rounded-4xl border border-violet-500/20 bg-violet-500/10 p-6 backdrop-blur-2xl">
            <h2 className="text-xl font-bold">Next Payment</h2>

            <div className="mt-6">
              <div className="text-5xl font-black">$24</div>

              <p className="mt-3 text-zinc-300">Charged on June 12, 2026</p>
            </div>
          </section>
        </aside>
      </div>
