...
//             Manage plans, payment methods, and invoices.
//           </p>
//         </div>
...
//                     Unlimited AI notes, advanced collaboration, workspace
//                     analytics, and priority AI usage.
//                   </p>
//                 </div>
...
//                 <Button className="h-12 rounded-2xl bg-violet-600 px-6 hover:bg-violet-500">
//                   Upgrade Plan
//                 </Button>
...
//                   <p className="text-sm text-zinc-400">Current monthly usage</p>
//                 </div>
//               </div>
